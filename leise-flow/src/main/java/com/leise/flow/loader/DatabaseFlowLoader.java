 ...
 * 
 * @title: DBFlowLoader.java
 * @package com.leise.flow.loader
 * @author leise
 * @date 2019年6月29日 下午5:47:08
 * @version v1.00
 ...
 * @author leise
 * @date 2019年6月29日 下午5:47:08
 * @classname: DBFlowLoader
 * @description: TODO(这里用一句话描述这个类的作用)
 */
@Component
@ConditionalOnProperty(name = "leise.flow.load.mode", havingValue = "database", matchIfMissing = true)
public class DatabaseFlowLoader implements FlowLoader {
